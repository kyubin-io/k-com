...
export default function NavMenu() {
  ...
  return (
    <>
      <li>
        <Link href="/home">
          <div className="inline-flex h-12 p-3 items-center hover:bg-slate-700 hover:bg-opacity-10 rounded-3xl">
            {segment === "home" ? (
              <>
                <svg
                  width={26}
              ...
              <>
                ...
                <div className="ml-5 mr-4 text-xl">홈</div>
              </>
            )}
          </div>
        </Link>
          ...
          <div className="inline-flex h-12 p-3 items-center hover:bg-slate-700 hover:bg-opacity-10 rounded-3xl">
            {segment && ["search", "explore"].includes(segment) ? (
              ...
              <>
                ...
                <div className="ml-5 mr-4 text-xl">탐색하기</div>
              </>
            )}
          </div>
        </Link>
          ...
          <div className="inline-flex h-12 p-3 items-center hover:bg-slate-700 hover:bg-opacity-10 rounded-3xl">
            {segment === "messages" ? (
              ...
              <>
                ...
                <div className="ml-5 mr-4 text-xl">쪽지</div>
              </>
            )}
          </div>
        </Link>
            ...
            <div className="inline-flex h-12 p-3 items-center hover:bg-slate-700 hover:bg-opacity-10 rounded-3xl">
              {segment === me.id ? (
                ...
                <>
                  ...
                  <div className="ml-5 mr-4 text-xl">프로필</div>
                </>
              )}
            </div>
          </Link>
